...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        if(User::isAdminUser($this->security->getUser())) {
            return new RedirectResponse($this->urlGenerator->generate("admin.index"));
        }elseif(User::isFarmerUser($this->security->getUser())) {
            return new RedirectResponse($this->urlGenerator->generate("farmer.index"));
        }else
