$(function() {
    ...
    $("#section2-slick-windows .slick").slick({
      ...
      fade: true,
      cssEase: 'linear',
      prevArrow: "<div class='prev'><img src='../image/icon/arrow3-left.svg' alt='fullland'></div>",
      nextArrow: "<div class='next'><img src='../image/icon/arrow3-right.svg' alt='fullland'></div>",
